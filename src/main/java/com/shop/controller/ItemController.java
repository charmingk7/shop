...
public class ItemController {
    ...
    public String itemNew(@Valid ItemFormDto itemFormDto, BindingResult bindingResult, Model model,
        ...
        try {
            //상품 저장 로직 호출
            //매개 변수로 상품 정보와 상품 이미지 정보를 담고 있는 itemImgFileList를 넘겨 준다.
        ...
        return "redirect:/";    //상품의 정상적으로 등록되었다면 메인 페이지로 이동
    }
    ...
    //valued에 상품 관리 화면 진입 시 URL에 페이지 번호가 없는 경우와 페이지 번호가 있는 경우 2가지를 매핑
    ...
    public String itemManage(ItemSearchDto itemSearchDto,
        ...
        //페이지 전환 시 기존 검색조건을 유지한 채 이동할 수 있도록 뷰에 다시 전달

...
public class ItemRepositoryCustomImpl implements ItemRepositoryCustom {
    ...
    //예를 들어 searchDateType 값이 "1m"인 경우 dateTime의 시간을 한달 전으로 세팅 후
    ...
    //상품 또는 상품 생성자의 아이디에 검색어를 포함하고 있는 상품을 조회하도록 조건값을 반환
    ...
    //where 조건절: BooleanExpression을 반환하는 조건문을 넣어준다. ',' 단위로 넣어줄 경우 and 조건으로 인식
    ...
    public Page<Item> getAdminItemPage(ItemSearchDto itemSearchDto, Pageable pageable) {
        ...
        //조회한 데이터를 Page 인터페이스의 구현체인 PageImpl 객체로 반환
    ...
    public Page<MainItemDto> getMainItemPage(ItemSearchDto itemSearchDto, Pageable pageable) {
        ...
        QueryResults<MainItemDto> results = queryFactory
                .select(
                        //QMainItemDto의 생성자에 반환한 값들을 넣어준다.
